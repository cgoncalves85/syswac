...
<div class="d-flex" id="wrapper">
  ...
  <div class="bg-light" id="sidebar-wrapper">
    ...
    <div class="list-group list-group-flush">
      ...
      <?= Html::a(Html::img('@web/img/icons/book-open-ini.png', ['class' => 'img-icon-sidebar']).'Pedidos', ['pedidos/create'], ['class' => 'list-group-item list-group-item-action bg-light']) ?>        
  ...
  <footer class="footer">
    <div class="container-fluid">
        <div class="text-center text-bold mt-2">
          © 2020 Copyright
          <a href="https://www.wearecontent.com/"> We Are Content</a>
        </div>
    </div>
  </footer>
</div>
